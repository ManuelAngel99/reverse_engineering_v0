(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, r, t) => {
    ...
    function x({
      ...
      let m = (0, u.useContext)(s.GlobalLayoutRouterContext);
      if (((0, u.useContext)(v.NavigationPromisesContext), !m))
        throw Object.defineProperty(
          Error("invariant global layout router not mounted"),
          "__NEXT_ERROR_CODE",
          { value: "E473", enumerable: !1, configurable: !0 },
        ...
        if (f) {
          ...
          if (null === e) {
            let t = (function e(r, t) {
              ...
              a = (0, b.hasInterceptionRouteInCurrentTree)(h),
              o = Date.now();
            ((n.lazyData = e =
              (0, i.fetchServerResponse)(new URL(c, location.origin), {
                flightRouterState: t,
                nextUrl: a ? m.previousNextUrl || m.nextUrl : null,
              }).then(
                (e) => (
                  (0, u.startTransition)(() => {
    ...
    function C({ name: e, loading: r, children: t }) {
      ...
      if (
        ...
        return (0, o.jsx)(u.Suspense, {
          name: e,
          fallback: (0, o.jsxs)(o.Fragment, { children: [a, l, r] }),
          children: t,
        });
      }
    ...
    function T({
      ...
      let {
        ...
        M = v.parallelRoutes,
        A = M.get(e);
      A || ((A = new Map()), M.set(e, A));
      let F = P[0],
        D = null === S ? [e] : S.concat([F, e]),
        N = P[1][e],
        k = N[0],
        I = (0, y.createRouterCacheKey)(k, !0),
        U = (0, _.useRouterBFCache)(N, I),
        H = [];
      do {
        let e = U.tree,
          u = U.stateKey,
          m = e[0],
          b = (0, y.createRouterCacheKey)(m),
          P = A.get(b);
        if (void 0 === P) {
          let e = {
            lazyData: null,
  ...
  (e, r, t) => {
    ...
    let n = e.r(530586).createRenderSearchParamsFromClient;
    ("function" == typeof t.default ||
      ("object" == typeof t.default && null !== t.default)) &&
      void 0 === t.default.__esModule &&
      (Object.defineProperty(t.default, "__esModule", { value: !0 }),
  ...
  (e, r, t) => {
    ...
    let n = e.r(503827).createRenderParamsFromClient;
    ("function" == typeof t.default ||
      ("object" == typeof t.default && null !== t.default)) &&
      void 0 === t.default.__esModule &&
      (Object.defineProperty(t.default, "__esModule", { value: !0 }),
  ...
  (e, r, t) => {
    ...
    function s({ Component: r, serverProvidedParams: t }) {
      ...
      if ("undefined" == typeof window) {
        ...
        let { createSearchParamsFromClient: c } = e.r(441779);
        t = c(s, u);
        let { createParamsFromClient: d } = e.r(237229);
        return ((o = d(i, u)), (0, n.jsx)(r, { params: o, searchParams: t }));
      }
      {
        let { createRenderSearchParamsFromClient: t } = e.r(393980),
          a = t(s),
          { createRenderParamsFromClient: o } = e.r(881478),
          l = o(i);
  ...
  (e, r, t) => {
    ...
    function u({ Component: r, slots: t, serverProvidedParams: u }) {
      ...
      if ("undefined" == typeof window) {
        ...
        let { createParamsFromClient: s } = e.r(237229);
        return ((o = s(c, u)), (0, n.jsx)(r, { ...t, params: o }));
      }
      {
        let { createRenderParamsFromClient: a } = e.r(881478),
          o = a(c);
